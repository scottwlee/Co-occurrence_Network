...
#================================================================================#
# 1.3.1 Chemosynthetic: For Seed(121)
#================================================================================#
...
# 박스플롯 시각화
# ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
# 📊 그래프 객체 생성 (정사각 비율 대비용)
# ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
p <- ggplot(node_degree_filtered, aes(x = Group, y = Degree, fill = Group)) +
  geom_boxplot(
    width = 0.6,
    outlier.shape = NA,
    alpha = 0.7,
    color = "black",
    size = 0.7  # 수염 및 테두리 두께 강조
  ) +
  labs(
    x = "Group",
    y = "Degree"
  ...
  theme(
    ...
    plot.margin = unit(c(1, 1, 1, 1), "cm")  # 여백 균일
  )

# ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
# 💾 고해상도 TIFF 저장 (정사각 비율 유지)
# ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
ggsave(
  filename = "Your Chemosynthetic Plot",
  plot = p,
  width = 6,
  height = 6,     # 정사각형 비율로 고정
  dpi = 600,
  units = "in",
  device = "tiff",
  compression = "lzw"
